      ...
      <div className="absolute left-1/2 -translate-x-1/2">
        ...
        <div className="hidden md:flex items-center space-x-2 bg-brand-surface p-1 rounded-lg">
            <button
                ...
                className={`flex items-center space-x-1.5 px-3 py-1 rounded-md text-sm ${viewMode === 'preview' ? 'bg-ide-bg-darker shadow-sm' : 'hover:bg-ide-bg-darker/50'}`}
            >
            ...
            <button
                ...
                className={`flex items-center space-x-1.5 px-3 py-1 rounded-md text-sm ${viewMode === 'code' ? 'bg-ide-bg-darker shadow-sm' : 'hover:bg-ide-bg-darker/50'}`}
            >
